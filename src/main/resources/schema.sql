-- ============================================================
-- Schema principal de Haida Inversiones Llantas
-- Gestiona todos los tipos y tablas. Usar con ddl-auto=validate.
-- ============================================================
...
CREATE TABLE IF NOT EXISTS pedidos (
    ...
    -- FIX: añadido distrito_envio que faltaba en el schema original
...
-- Guarda una clave única por intento de pago.
-- Si el mismo idempotency_key llega dos veces, se retorna el pedido original.
